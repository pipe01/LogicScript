        ...
        Variable PortVariable(string name, MachinePortInfo port)
        {
            ...
            return new Variable
            {
                ...
                Value = FormatBitsValue(port.Target switch
                {
                    ...
                    MachinePorts.Register => CurrentPause!.ScriptInstance.GetRegister(port.StartIndex, 0),
            ...
            return Enumerable.Range(start, Math.Min(count, port.VectorLength))
                .Select(vi => new Variable()
                {
                    ...
                    Value = FormatBitsValue(port.Target switch
                    {
                        ...
                        MachinePorts.Register => CurrentPause!.ScriptInstance.GetRegister(port.StartIndex, vi),
                        _ => throw new NotImplementedException()
                    }, port.BitSize)
                });
        }
